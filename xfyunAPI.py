...
logger = Logger(LoggerName="xfyunAPI")
...
class Ws_Param(object):
    ...
    def __init__(self, APPID, APIKey, APISecret, AudioFile):
        ...
        self.BusinessArgs = {"domain": "iat", "language": "en_us",
                             "accent": "mandarin", "vinfo": 1, "vad_eos": 10000, "ptt": 0}
    ...
    try:
        ...
        if code != 0:
            ...
            for i in data:
                for w in i["cw"]:
                    result += w["w"]
            logger.info("sid:%s call success!,data is:%s" %
...
wsParam = None
def asr(APPID, APISecret, APIKey, AudioFile):
    global wsParam
