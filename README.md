...
```
 ...
 Python:
   configuration env ... and run python3 main.py
 Docker:
   docker build ... and docker run -e USERNAME=xxx -e PASSWORD=xxx -e TWOCAPTCHA_TOKEN=xxx -e APP_ID=xxx -e API_KEY=xxx -e SECRET_KEY=xxx -e TELE_ID=xxx -e TELE_TOKEN=xxx -e ASR_CHOICE=xxx -it --rm  [镜像]
```
