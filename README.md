...
`woiden.id` 和 `hax.co.id` 自动续订成功率基本💯</br>
...
- [x] `Xfyun` 每月 500 次免费音频流</br><a id='001' />
    ...
    - ⚠ `Python Script` 直接运行需要安装 [xfyunAPI.py 的依赖项](https://github.com/Zakkoree/woiden_extend/blob/main/xfyunAPI.py#L4-L10) 和打开 `main.py` [22行](https://github.com/Zakkoree/woiden_extend/blob/main/main.py#L22) 和 [398~402行](https://github.com/Zakkoree/woiden_extend/blob/main/main.py#L402-L406) 的注释
