...
~~还可以使用 Cloudflare 代理转发流量搭建 VPN ( V2Ray WebSocket + TLS + Nginx + CDN 或者 V2Ray Http2 + TLS + Caddy +CDN ) ，hax 和 woiden 都可以搭建( 这里 hax 和 woiden 的网速就有区别了 )，设置 Cloudflare 自选 IP 节点后网速会有所提升，但配置繁琐且稳定性没有组网好，在 speedtest.net 测试有的节点能干到200+，但是实际体验并不好~~
